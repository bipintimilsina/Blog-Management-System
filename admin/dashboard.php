...
// Fetch counts
$comments_this_week = getCommentsThisWeek($conn);
$likes_this_week = getLikesThisWeek($conn);
$visits_this_week = getVisitsThisWeek($conn);
...
<div class="container">
    ...
    <div class="dashboard-container">
        <div class="dashboard-stat">
            ...
            <p><?php echo $comments_this_week; ?></p>
        </div>
        <div class="dashboard-stat">
            <h2>Likes This Week</h2>
            <p><?php echo $likes_this_week; ?></p>
        </div>
        <div class="dashboard-stat">
            <h2>New Visits This Week</h2>
            <p><?php echo $visits_this_week; ?></p>
        </div>
    </div>
</div>
      </div>
