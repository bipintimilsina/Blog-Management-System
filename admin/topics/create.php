      ...
      <div class="content">
        ...
        <form action="create.php" method="post">
          <div>
            ...
            <!-- <input type="text" name="title" id="editor" class="text-input" /> -->
            <textarea name="description" id="editor" cols="30" rows="10"><?php
            echo $description;
            ?></textarea>
          </div>
          <div>
            <!-- <a type="submit" class="btn btn-big"></a> -->
            <input type="submit" name="add-topics" style=" width: 150px; margin: 10px 0px;display:flex"
              href="create.php" class="btn btn-big" value="Add Topics">
