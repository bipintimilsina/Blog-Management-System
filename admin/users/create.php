  ...
  <div class="admin-wrapper">
    ...
    <div class="admin-content">
      <div class="btn-group">
        ...
        <a href="index.php" class="btn btn-big">Edit User</a>
      </div>
      <div class="content">
        ...
        <form action="create.php" method="post">
          ...
          <div>
            ...
            if (isset($admin) && $admin == 1) { ?>
              ...
              <label for="admin">
                <input checked type="checkbox" name="admin">Admin
          ...
          <div>
            <input type="submit" name="create-admin" style=" width: 150px; margin: 10px 0px;display:flex"
